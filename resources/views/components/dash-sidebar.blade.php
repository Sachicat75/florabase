@php
    $links = [
        ...
        ['label' => 'Security', 'route' => 'user.security'],
    ];
@endphp
            ...
            @foreach ($links as $link)
                ...
                <li>
                    <a
                        ...
                        class="flex items-center rounded-lg px-3 py-2 transition {{ $isActive ? 'bg-primary-50 text-primary-700 dark:bg-primary-500/10 dark:text-emerald-400' : 'text-gray-700 hover:bg-gray-100 hover:text-gray-900 dark:text-gray-300 dark:hover:bg-gray-700 dark:hover:text-white' }}"
                    >
